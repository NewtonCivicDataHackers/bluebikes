...
This script combines functionality from count_trips.py and count_trips_pairs.py
to analyze BlueBikes bikeshare data. It can perform station-level or station-pair
analysis based on command-line arguments.

Usage:
    cat trip_data.csv | python aggregate.py --stations > station_stats.csv
    cat trip_data.csv | python aggregate.py --station-pairs > station_pairs_stats.csv
...
Features:
    ...
    - Same metrics and calculations as individual scripts
"""
